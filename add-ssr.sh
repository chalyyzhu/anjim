...
# =======================================
proxies:
  - {name: SSR_clash@ZhoeVPN, server: ${BUG}.${domain}, port: ${ssr_port}, type: ssr, cipher: aes-256-cfb, password: $ssr_user, protocol: origin, obfs: tls1.2_ticket_auth, protocol-param: $BUG, obfs-param: $BUG, udp: true}
port: 3333
socks-port: 23456
redir-port: 23457
allow-lan: true
