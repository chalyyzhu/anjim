...
clear
echo -e "${Info} XRAY CORE VPS AutoScript by ZHOEvpn"
# Detect public IPv4 address and pre-fill for the user
# Domain 
domain=$(cat /etc/rare/xray/domain)
# Uuid Service
uuid=$(cat /proc/sys/kernel/random/uuid)
echo -e "\e[0;32m XRAY CORE VPS AutoScript by ZHOEvpn\e[0m"
...
cd /usr/bin
wget -O xray-menu "https://raw.githubusercontent.com/chalyyzhu/anjim/main/xray-menu.sh"
chmod +x xray-menu
cd
systemctl daemon-reload
