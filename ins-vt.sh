...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/chalyyzhu/anjim/main/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
cd /usr/bin
wget -O add-tr "https://raw.githubusercontent.com/chalyyzhu/anjim/main/add-tr.sh"
wget -O del-tr "https://raw.githubusercontent.com/chalyyzhu/anjim/main/del-tr.sh"
wget -O cek-tr "https://raw.githubusercontent.com/chalyyzhu/anjim/main/cek-tr.sh"
wget -O renew-tr "https://raw.githubusercontent.com/chalyyzhu/anjim/main/renew-tr.sh"
chmod +x add-tr
chmod +x cek-tr
chmod +x del-tr
chmod +x renew-tr
